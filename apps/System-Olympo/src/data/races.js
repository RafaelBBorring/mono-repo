...
export const RACES = {
  ...
  DEMONIO: {
    ...
    layer0: { attrBonus: { AM: 3, escolher: true, escolherQtd: 2, escolherLabel: 'FOR ou DES' }, hpMod: 50 },
    passivasRaciais: [
  ...
  SEMIDEUS: {
    ...
    deuses: [
      ...
      { id: 'HEBE', name: 'Hebe', title: 'Deusa da Juventude', attr: { CON: 3, AM: 3, APA: 2 }, traco: 'Toco da Juventude (1×/dia: restaura 50% HP e remove condições)', especial: '+20 HP permanente. Aliados em 10m recuperam 2 HP/turno. Imune a envelhecimento' },
    ...
    passivasRaciais: [
      { nome: 'Herança Divina', tipo: 'Passiva', custo: '—', duracao: 'Contínuo', efeito: 'Poder do deus pai desde a criação. Dano, resistência e efeitos conforme linhagem' },
    ...
    vantagens: [
      'Poder do deus pai: específico e poderoso',
      'Pode invocar poder do pai 1×/descanso longo',
      'Não envelhece normalmente',
    ],
    desvantagens: [
      'Herda fraquezas específicas do pai (narrativo + mecânico)',
    ...
    progressaoPoder: [
      { nivel: 1, ganho: 'Despertar Divino', desc: 'Herança completa. Todos os traços e poderes do deus pai ativos' },
      { nivel: 10, ganho: 'Domínio I', desc: 'Poder +3 dano/efetividade. Alcance/área +50%. +3 atributo principal do pai' },
      { nivel: 20, ganho: 'Domínio II', desc: 'Poder 2×/descanso. +3 adicional. Aura 25m. +40 HP permanente' },
      { nivel: 30, ganho: 'Ascensão Divina', desc: 'Desafia pai por divindade. Poder 3×/dia. Praticamente imortal. +4 em atributos do pai' },
    ],
    marcosExperiencia: [
