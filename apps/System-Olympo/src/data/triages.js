export const TRIAGES = {
  GUERREIRO: {
    TÁTICO: {
      ...
      levels: {
        ...
        0.2: '03 PE — Marca Alvo; ataques aliados ganham +12 de Dano contra ele por 04 Rodadas. 1× marca ativa por vez.',
        0.3: 'Marca 02 Inimigos simultaneamente; se ambos caírem em 03 Rodadas, aliados recuperam 08 PE (1× por combate).',
        0.4: 'Com 06 PE, escolhe 01 Aliado para atacar junto; ambos recebem +4 no Resultado. 1×/rodada.',
        0.5: '1× por Combate, todos os Aliados podem mover 15m sem Ataques de Oportunidade e ganham +2 CA por 1 Rodada.',
        0.6: 'Gasta 10 PE para conceder 1 Ação Padrão + 1 Ação de Movimento a 01 Aliado por 01 Rodada (1×/combate).',
      },
    },
    LUTADOR: {
      name: 'Lutador',
    ...
    TANK: {
      ...
      levels: {
        ...
        0.2: 'Gasta 3 PE para absorver o dano de um Aliado a 5m (recebe +2 PE ao usar). 1×/rodada.',
        0.3: '50% da Constituição se torna sua Armadura Natural. +2 CA contra ataques à distância.',
        0.4: 'Após crítico bem-sucedido, recebe 100% do CON em Vida Temporária (3 Rodadas). 1×/combate.',
        0.5: 'Até 3× por Combate, usa 05 PE para reduzir 50% do Dano Físico recebido.',
        0.6: 'Armadura Natural equivale a 100% da Constituição. Aliados a até 3m sofrem -2 no dano recebido.',
      },
    },
    SOLDADO: {
      name: 'Soldado',
      ...
      levels: {
        ...
        0.3: 'Gasta 05 PE para atordoar o alvo (DT: CON 16+modCON); desvantagem na próxima ação. 1×/rodada.',
  ...
  OPERATIVO: {
    ASSASSINO: {
      ...
      levels: {
        0.1: 'Após 3 Golpes bem-sucedidos em um alvo, o próximo recebe +4d12 de dano. Reset ao trocar de alvo.',
        0.2: 'A cada 15 pontos em Destreza, recebe +1 Reação. +1d6 em Ataque contra alvos com <50% vida.',
        0.3: '06 PE define um alvo marcado; recebe +2d6 em Testes de Ataque contra ele por 4 Rodadas (1×/combate).',
        0.4: 'Ao atacar um alvo pela primeira vez no combate, recebe +1 Ação de Movimento e +1d8 de dano.',
        0.5: 'Ao atingir crítico no inimigo, aplica +3d8 de Dano por 3 Rodadas. 1×/alvo.',
    ...
    INFILTRADO: {
      ...
      levels: {
        ...
        0.3: 'Gastar a ação de movimento e 5 PE dobra o bônus do ataque furtivo neste ataque (1×/rodada).',
        0.4: 'Caso ataque furtivo seja crítico, recebe Vantagem nos próximos 2 Ataques e +2d6 de dano.',
        0.5: 'Após um ataque, pode gastar 5 PE para receber +15 no teste de furtividade (ação livre). 1×/rodada.',
    ...
    ATIRADOR: {
      ...
      levels: {
        ...
        0.3: 'Gasta 8 PE para disparar mais uma vez com -1d6 no resultado (limite 2×/turno).',
        0.4: 'Usando Armas à distância, pode usar 4 PE para Derrubar/Empurrar (DT FOR 16). +1d10 se acertar.',
        0.5: 'Ao Mirar (ação), gasta 5 PE para aumentar margem de crítico em +2 e ignorar cobertura (1×/turno).',
    ...
    'TÉCNICO': {
      ...
      levels: {
        ...
        0.2: '+12 em Testes de Computação/Engenharia. Pode criar gadgets básicos com materiais do ambiente (1×/cena).',
        0.3: 'Após acertar um Ataque, aplica Desvantagem no Ataque ou Defesa do alvo por 03 Rodadas (1×/alvo).',
        0.4: 'Explosivos causam INT×2 na soma do Dano. Área de efeito aumentada em 50%.',
        0.5: 'Gasta 06 PE para modificar uma Arma e deixá-la com Vantagem até fim do combate (1 arma por vez).',
  ...
  MISTICO: {
    COMBATE: {
      ...
      levels: {
        0.1: 'Após atingir o mesmo alvo 3× com habilidades, recebe +8 de Energia (1× por alvo por combate).',
        0.2: 'Adiciona +1d8+FOR a cada 10 Níveis no Dano Base de habilidades mágicas.',
        0.3: 'Ao sofrer dano mágico, pode gastar 4 PE para reduzi-lo em 30% (1×/rodada).',
        0.4: 'Ao eliminar um inimigo, recupera até AM de Energia gasta na ação final (1×/rodada).',
        0.5: 'Ao atingir crítico com habilidade, soma AM no Dano e recupera 2 PE. 1×/rodada.',
        0.6: 'Após atingir o mesmo alvo 3×, recebe +AM de Energia e +1d12 no próximo ataque (1× por alvo por combate).',
      },
    },
    SUPORTE: {
      name: 'Suporte',
      ...
      levels: {
        0.1: 'Gasta 8 PE para reduzir 30% do custo de Buffs de aliados por 3 Rodadas (1×/combate).',
        0.2: 'Usa 1 Ação de Movimento para remover um efeito negativo de um aliado + 1d4 de cura.',
        0.3: 'Ao ajudar um aliado, usa 4 PE para que ambos recebam +5 em Reações e +2 CA até próximo turno (1×/rodada).',
        0.4: '1× por Cena, usa 10 PE para recuperar aliado em "Morrendo" com 35% da Vida + Temporária (CON).',
        0.5: 'Usa 5 PE para remover um Ferimento recente e conceder +2 Fortitude por 2 Rodadas.',
        0.6: 'Pode usar 6 PE para ampliar em 40% um Buff ativo em aliado e estender em +1 Rodada (1×/buff).',
      },
    },
    INTUITIVO: {
      name: 'Intuitivo',
      ...
      levels: {
        ...
        0.2: 'Gastando 3 PE, pode aumentar o alcance em 50% ou a área em +2m de uma Habilidade (1×/habilidade).',
        0.3: 'Gasta 05 PE para conjurar Habilidade como Ação de Movimento (1×/rodada).',
        0.4: 'Usa 10 PE para criar combo com até 3 Habilidades em 1 ação. Custo total ≤ Energia máxima. 1×/combate.',
        0.5: '5 PE para aplicar novo efeito à habilidade: +2 Rodadas / +20% dano / Atordoar (DT AM). 1×/habilidade/combate.',
        0.6: 'Recebe 1 Habilidade Passiva extra. Habilidades fora de combate custam -30% Energia.',
      },
    },
    GRADUADO: {
      name: 'Graduado',
      ...
      levels: {
        0.1: 'Permite converter 02 Energia em 01 PE e vice-versa (ação livre, até 3× por combate).',
        0.2: 'Aprende Mod.INT÷3 habilidades extras (arredondado para baixo). +5 em testes de Conhecimento.',
        0.3: 'Inimigos que resistem às suas habilidades têm -4 no próximo Teste e sofrem 50% do dano (1×/alvo).',
        0.4: 'Sucesso crítico retorna 50% da Energia/PE gastos na ação e Vantagem no próximo teste. 1×/rodada.',
        0.5: 'Aprende +Mod.INT÷3 habilidades extras. Habilidades de Alquimia causam +20% dano.',
        0.6: '5 PE identifica fraqueza; recebe Vantagem no Ataque, ignora Armadura e +2d8 por 2 Rodadas (1×/alvo/combate).',
      },
    },
  },
}
