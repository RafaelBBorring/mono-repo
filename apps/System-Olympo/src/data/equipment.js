...
export const SIMPLE_ITEMS = [
  ...
  { id: 'pocao_vida_p', nome: 'Pocao de Vida Pequena', desc: 'Frasco leve para recuperacao rapida.', efeito: 'Recupera 25 de Vida. Consumivel.', peso: 0.2 },
  { id: 'pocao_vida_m', nome: 'Pocao de Vida Media', desc: 'Frasco reforcado para ferimentos moderados.', efeito: 'Recupera 60 de Vida. Consumivel.', peso: 0.35 },
  { id: 'pocao_vida_g', nome: 'Pocao de Vida Grande', desc: 'Frasco concentrado para emergencias graves.', efeito: 'Recupera 120 de Vida. Consumivel.', peso: 0.5 },
  { id: 'pocao_energia_p', nome: 'Pocao de Energia Pequena', desc: 'Mistura estimulante de baixa dose.', efeito: 'Recupera 25 de Energia. Consumivel.', peso: 0.2 },
  { id: 'pocao_energia_m', nome: 'Pocao de Energia Media', desc: 'Mistura de recuperacao energetica estavel.', efeito: 'Recupera 60 de Energia. Consumivel.', peso: 0.35 },
  { id: 'pocao_energia_g', nome: 'Pocao de Energia Grande', desc: 'Mistura concentrada para desgaste intenso.', efeito: 'Recupera 120 de Energia. Consumivel.', peso: 0.5 },
  { id: 'seringa_vital', nome: 'Seringa Vital', desc: 'Dose injetavel para uso em combate.', efeito: 'Recupera 80 de Vida como acao rapida. Consumivel.', peso: 0.15 },
  { id: 'seringa_energia', nome: 'Seringa de Energia', desc: 'Dose injetavel de recuperacao energetica.', efeito: 'Recupera 80 de Energia como acao rapida. Consumivel.', peso: 0.15 },
  { id: 'seringa_pe_temp', nome: 'Seringa de PE Temporario', desc: 'Dose instavel de pico heroico.', efeito: 'Concede 2 PE temporarios ate o fim da cena. Consumivel.', peso: 0.15 },
